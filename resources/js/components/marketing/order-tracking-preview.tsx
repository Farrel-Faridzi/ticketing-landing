...
export function OrderTrackingPreview() {
    return (
        <div className="flex justify-center px-6 py-10 md:px-16">
            <div className="border-mkt-border bg-mkt-card w-full max-w-[640px] rounded-[20px] border p-7 shadow-lg">
                <div className="mb-6 flex items-center justify-between">
                    <div className="text-text-faint text-[13.5px] font-semibold">
                        Order ID #RSV-20441
                    </div>
                ...
                <div className="text-text-faint mt-4.5 text-center text-[12.5px]">
